            ...
            <div className="mb-4 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Rows: {scheduleImportPreview.length} Ã¢â‚¬Â¢ Ready: {importReadyCount} Ã¢â‚¬Â¢ Issues: {importIssueCount}
                </p>
              </div>
                  ...
                  >
                    <div className="sticky left-0 z-20 border-r border-slate-200 bg-white px-4 py-3">
                      ...
                      <p className="mt-1 text-xs text-slate-500">
                        {employee.position || "-"} Ã¢â‚¬Â¢ {employee.employee_no || "-"}
                      </p>
                    </div>
