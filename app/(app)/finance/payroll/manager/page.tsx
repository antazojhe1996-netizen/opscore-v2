      ...
      <section className={`${shellCard} overflow-hidden`}>
        <div className="grid gap-4 p-5 xl:grid-cols-[1.4fr_1fr] xl:items-stretch">
          <div className="rounded-3xl border border-slate-100 bg-white p-4">
            ...
            <p className="mt-1 text-sm font-medium text-slate-600">Per-employee payroll workflow. Manager Review Ã¢â€ â€™ Locked Ã¢â€ â€™ Released. Returns affect one employee only.</p>
          </div>
                ...
                {filteredRows.map((record) => {
                  ...
                  return (
                    <tr key={record.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="px-4 py-4"><div className="font-black text-slate-950">{getEmployeeName(record)}</div><div className="mt-1 text-[11px] font-semibold text-slate-500">{record.department || "Unassigned"} Ã¢â‚¬Â¢ {record.position || "Unassigned"}</div></td>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold text-slate-500">
                    {partialReleaseRecord.department || "Unassigned"} Ã¢â‚¬Â¢ {partialReleaseRecord.position || "Unassigned"}
                  </p>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
          <div className="w-full max-w-2xl rounded-[28px] border border-slate-200 bg-white p-6 shadow-2xl">
            ...
            <div className="mt-5 rounded-3xl border border-rose-200 bg-rose-50 p-4 text-sm font-bold text-rose-700">
              Selected employees will return to the Locked tab as PARTIALLY RELEASED with Ã¢â€šÂ±0.00 actual paid and full net pay remaining.
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <div className={metricCard}>
                ...
                <p className="mt-2 text-lg font-black text-blue-700">Ã¢â€šÂ±0.00 each</p>
              </div>
              <div className={metricCard}>
            ...
            <div className="mt-5 rounded-3xl border border-slate-200 bg-slate-50 p-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold text-slate-500">
                    {reopenPaymentRecord.department || "Unassigned"} Ã¢â‚¬Â¢ {reopenPaymentRecord.position || "Unassigned"}
                  </p>
                </div>
