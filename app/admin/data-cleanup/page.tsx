...
export default function DataCleanupPage() {
  ...
  const deleteData = async () => {
    ...
    setMessage("Test data cleanup completed. Tables are still intact.");
    setConfirmation("");
    scanDatabase();
  };
      ...
      <main className="min-w-0 flex-1 overflow-x-hidden px-4 py-8 sm:px-6 lg:px-7">
        <section className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-4xl text-sm font-medium text-slate-500">
              Preview test records before production encoding. This deletes data
              rows only, not tables.
            </p>
          </div>
        ...
        <section className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
          <SummaryCard
            ...
            helper="Total test rows included in cleanup preview."
          />
          <SummaryCard
        ...
        <section className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
          ...
          <aside className="rounded-3xl border border-red-200 bg-red-50 shadow-sm">
            ...
            <div className="space-y-4 p-6">
              <p className="text-sm font-bold leading-6 text-red-800">
                This will permanently delete previewed rows. Tables and columns
                will remain intact.
              </p>
              ...
              <button
                onClick={deleteData}
                disabled={
                  deleting || loading || confirmation !== CONFIRM_TEXT || totalRows === 0
                }
