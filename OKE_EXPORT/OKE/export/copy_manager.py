...
class CopyManager:
    ...
    def __init__(self):
        ...
        self.directory_targets = [
            {
                "source": self.project_root / "OKE",
                "destination": self.output_dir / "OKE",
                "required": True,
            },
            {
                "source": self.project_root / "OKE" / "workspace" / "reports",
                "destination": self.output_dir / "reports",
                "required": False,
            },
        ]
    ...
    def copy(self):
        ...
        for item in self.directory_targets:
            source = item["source"]
            destination = item["destination"]
